...
# C-D etc
#
# Use a circular linked list, fill it up using the pairs and keep checking. Use a stack to put pairs in
# it if not found in circular list. Pop from stack when something is added in circular list.
#
...
# When something is inserted in queue, front or rear would change. So now search for rear
# or front in stack, if found remove it and add in queue. Repeat until no front or rear is found.
# Go to step 2
#
