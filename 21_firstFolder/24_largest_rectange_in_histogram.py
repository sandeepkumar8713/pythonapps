...
# Question : Find the largest rectangular area possible in a given histogram where the largest rectangle can
...
#              For hist[tp], the 'left index' is previous (previous to tp) item in stack and 'right index' is
#              'i' (current index).
#        3) If the stack is not empty, then one by one remove all bars from stack and do step 2.b for every removed bar.
#        Logic : def updateMaxArea(stack, i, maxArea):
#        topIndex = stack.pop()
#        width = 0
