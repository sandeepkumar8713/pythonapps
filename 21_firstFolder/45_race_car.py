...
# otherwise speed = 1.  (Your position stays the same.) For example, after commands "AAR",
# your car goes to positions 0->1->3->3, and your speed goes to 1->2->4->-1. Now for some
# target position, say the length of the shortest sequence of instructions to get there.
#
