...
#        Call a recursive function modifyBSTUtil(root, k) where k is passed by pointer.
#           If root is None: return
#           Call modifyBSTUtil() over root.right
#           Now it has reached its largest element.
#           Set oldVal = root.data. Add k to original data root.data += k[0]
#           Now update the k value by adding with oldVal : k[0] += oldVal.
#           This new value k will be sent ahead.
