# Question : There are n people standing in a circle waiting to be executed. The counting
# out begins at some point in the circle and proceeds around the circle in a fixed direction.
...
# skipped and kth person is killed in circle. The task is to choose the place in the
...
#        position returned by josephus(n-1,k) will consider the position starting from k%n + 1.
