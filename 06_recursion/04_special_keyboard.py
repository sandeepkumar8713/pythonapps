...
#          these values for the break-point, and compute that optimal string they would produce.
#          Like 16 from 9 keystrokes.
#        Level 3: Use level 2 values, do Ctrl-A, Ctrl-C once and the only Ctrl-V's afterwards to generate the optimal
#          length. here formula is : curr = (n-b-1)*screen[b-1] (b is the no. of keystrokes already entered before copy)
