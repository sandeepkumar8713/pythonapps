...
# Question : Given an array of positive integers (possibly with duplicates) such that the numbers have been sorted
# only by 28 most significant bits. Sort the array completely.
#
