...
#           already visited vertex which is already in current recursion stack return True. While existing a stack
#           (recursive func call), mark that vertex in recStack as false.
    ...
    def isCyclicUtils(self, v, visited, recStack):
        ...
        for i in self.graph[v]:
            if visited[i] is False:
                if self.isCyclicUtils(i, visited, recStack) is True:
                    return True
