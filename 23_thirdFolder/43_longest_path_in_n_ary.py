...
# to the farthest leaf node. An n-Ary tree was given with their level of stickiness on
# the edges.If the water is falling from the root, find the max time taken to wet the
# whole tree.
#
# Question Type : Easy
