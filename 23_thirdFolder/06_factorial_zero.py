...
#
# Question Type : Easy
# Used : A trailing zero is created with multiples of 10, and multiples of 10 are created with
#        pairs of 5-multiples and 2-multiples. Therefore, to count the number of zeros, we
