...
# has one character. Find all possible words that can be formed by a sequence of adjacent
...
#
# Solution : Here call findPath() multiple times considering all the cell as starting point
