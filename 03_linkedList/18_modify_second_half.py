# Question :  Given a Singly Linked list, Update the second half of the list such that n - th element becomes
...
#        Now reverse the second half. midPointer.next = reverse(head, midPointer.next, halfSize)
#        Run a loop using first and second pointer for halfSize. Sum corresponding data and save in second list.
