...
# Used : Simply use separate queues for dogs and cats, and to place them within a wrapper class
#        called AnimalQueue. We then store some sort of timestamp(or order number) to mark when each
#        animal was enqueued. When we call dequeueAny, we peek at the heads of both the dog and cat
#        queue and return the oldest.
# Complexity : O(n)
#
# TODO :: add code
