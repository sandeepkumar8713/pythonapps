...
# Question : Given an array with n positive integers. We need to find the minimum number of operation to make all
# elements equal. We can perform addition, multiplication, subtraction or division with any element on an array element.
#
# Input : arr[] = {1, 2, 3, 4}
# Output : 3
...
#        and for this your selection of target is very important because if you select a target whose frequency in
#        array is x then you have to perform only n-x more operations as you have already x elements equal to your
