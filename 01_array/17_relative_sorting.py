# Question : Given two arrays A1[] and A2[], sort A1 in such a way that the relative order
...
#        1. If num1 and num2 both are in A2 then number with lower index in A2 will be
#           treated smaller than other.
#        2. If only one of num1 or num2 present in A2, then that number will be treated
#           smaller than the other which doesn't present in A2.
