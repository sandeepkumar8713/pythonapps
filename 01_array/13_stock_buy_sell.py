...
# Question : The cost of a stock on each day is given in an array, find the max profit
# that you can make by buying and selling in those days. For example, if the given array
