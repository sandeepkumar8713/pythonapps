...
# Similar : https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/
# Question : The cost of a stock on each day is given in an array, find the max profit that you can make
# by buying and selling in those days. For example, if the given array is {100, 180, 260, 310, 40, 535, 695},
