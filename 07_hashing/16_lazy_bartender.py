...
#
# Question Type : Easy
# Used : For the given input matrix make a map
#        drinkCustMap : key (drink) : value (list of customer who like it)
#        Run a loop till this map is empty. Find the drink which is most fav to all, serve it.
#           Remove that drink from map. Remove those customers from the map who are already
#           served.
