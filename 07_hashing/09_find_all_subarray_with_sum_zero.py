# Question : Given an array, print all subarrays in the array which has sum 0.
#
...
#           append {0:i} to the result. If sumSoFar is already in the hashDict then there exists at-least one sub array
