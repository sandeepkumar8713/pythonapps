# CTCI : Q16_20_T9
# Similar : https://www.geeksforgeeks.org/find-possible-words-phone-digits/
...
def initializeDictionary(wordList):
    letterToNumberMap = {}
    for i in range(len(t9Letter)):
        if t9Letter[i] is not None:
            for letter in t9Letter[i]:
                letterToNumberMap[letter] = i

    numberToWordMap = {}
    for word in wordList:
        number = ""
        for letter in word:
            number += str(letterToNumberMap[letter.lower()])
        if number not in numberToWordMap.keys():
            numberToWordMap[number] = [word]
        else:
            numberToWordMap[number].append(word)
...
if __name__ == "__main__":
    wordList = ["the", "of", "and", "a", "to", "in", "is", "be",
				...
				"without", "however", "govern", "dont", "does", "got",
				...
				"large", "until", "always", "city", "didnt", "order", "away",
				...
				"force", "study", "York", "action", "its", "door",
				...
				"simply", "cant", "story", "committee", "inside", "reached",
				...
				"floor", "piece", "especially", "indeed", "stop", "wasnt",
				...
				"dance", "Ive", "regard", "mans", "train", "herself",
				...
				"ship", "theres", "council", "EFFECTS", "event", "worth",
				...
				"permit", "covered", "Negro", "played", "Id", "vote",
				...
				"doesnt", "finished", "carefully", "facts", "nice",
				...
				"allowance", "bitter", "realized", "lets", "moon",
				...
				"enjoy", "bless", "emotional", "promise", "shed", "wave",
				...
				"decrease", "trust", "yourself", "legs", "youve",
				...
				"lake", "theyre", "slope", "Typical", "spite", "wore", "dear",
				"employees", "map", "pair", "spin", "ones", "praise",
				...
				"improve", "maintenance", "seize", "Laos", "well", "dozen",
