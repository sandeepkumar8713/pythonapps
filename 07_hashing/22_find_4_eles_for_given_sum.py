...
# Question : Given an array of integers, find any one combination of four elements in the
# array whose sum is equal to a given value X.
#
# Question Type : Easy
# Used : Run 2 loops to make pairs from the given array. Save its sum as key and indexes as
#        value in map.
#        Now again run 2 loops to make pair, subtract this pair's sum with target sum,
#        check if other part sum is present in the map. Check if indexes are repeated,
