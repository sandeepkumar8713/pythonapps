...
# Used : DP with DFS and backtracking
#        We have to use kind of backtracking. We have to permute all valid sequence.
...
# Logic: def calculate(n, num, visited, count):
#        if num > n:
#           count[0] += 1
#           return
...
# Complexity : O(n * k) k is no. of valid permutation
