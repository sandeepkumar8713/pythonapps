...
# Used : Use bfs/level order traversal while keeping track of a distance from a root. If the first
#        occurrence of each number of the given array is found, update the result array with the
#        current distance.
