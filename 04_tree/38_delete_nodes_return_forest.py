...
# Used : Do post order traversal of the given tree, with a result list.
#        If the current node is present in the toBeDeleted list,
#        append left and right subtree in the result list and return None
#        else return Node.
#        Logic :
