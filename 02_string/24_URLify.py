...
#
# Question Type : Easy
# Used : Find true length without trailing space. Find space count within true length.
#        Now calculate newIndex (trueLength + (spaceCount * 2). Make a empty list listStr
#        of size newIndex. Now start filling the listStr in
