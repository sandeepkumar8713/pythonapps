...
# Used : Do BFS, from the adjacent nodes(4 directions) of the given black node.
#        Also keep a set of visited whites.
#        While doing BFS, push only white enemy in nodes, skip the node if it is already
#        visited or black and break BFS if any empty slot is found. (return 0 capture)
#        Keep increasing count of white enemy found.
#        Logic :
#        max_capture(board, row, col):
